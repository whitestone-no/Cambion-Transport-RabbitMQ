...
{
    // Use a collection to not run these tests in parallel with RabbitMqTransportCustomConfigTests
    // as these will interfere with eachother
    [Collection("RabbitMQ Integration Tests")]
    public class RabbitMqTransportConnectionStringConfigTests(RabbitMqConnectionStringConfigFixture fixture) : IClassFixture<RabbitMqConnectionStringConfigFixture>
    {
        [Fact]
